...
#include <netinet/in.h> //#include <netinet/in.h> -> contain defination,constat and sturcture (e.g.- 'sockaddr_in')for internet domain address
#include <arpa/inet.h> //#include <arpa/inet.h> -> contains definitions for internet operations .
...
{
    printf("%s", "> ");
    fflush(stdout);  // to flush the output buffer of the stream
}
...
int main(int argc, char **argv)
{
    ...
    struct sockaddr_in server_addr;// sockadd_in structure...
